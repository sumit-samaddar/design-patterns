...
public class Computer {
    ...
    public boolean equals(Object obj) {
        ...
        if (isBluetoothEnabled == null) {
            if (other.isBluetoothEnabled != null) return false;
        } else if (!isBluetoothEnabled.equals(other.isBluetoothEnabled)) return false;
        if (isGraphicsCardEnabled == null) {
            return other.isGraphicsCardEnabled == null;
        } else return isGraphicsCardEnabled.equals(other.isGraphicsCardEnabled);
    }
